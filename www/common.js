...
/***/ "./src/app/services/notificationservices.ts":
/*!**************************************************!*\
  !*** ./src/app/services/notificationservices.ts ***!
  \**************************************************/
/*! exports provided: Notificationservices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Notificationservices", function() { return Notificationservices; });
/* harmony import */ var _services_env__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/env */ "./src/app/services/env.ts");
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm5/http.js");


var Notificationservices = /** @class */ (function () {
    function Notificationservices(http, toastCtrl, loadingCtrl, htttp, commonService) {
        this.http = http;
        this.toastCtrl = toastCtrl;
        this.loadingCtrl = loadingCtrl;
        this.htttp = htttp;
        this.commonService = commonService;
        this.env = new _services_env__WEBPACK_IMPORTED_MODULE_0__["Env"]();
    }
    ////New Shop Add Notification////
    Notificationservices.prototype.newNotification = function (options) {
        var _this = this;
        ...
        var header = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({ 'Content-Type': 'application/json', 'Authorization': 'key=AIzaSyDfYSP9dtOZJtbAb_2cYm59EMK7WZ9vUk8' });
        var request = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestOptions"]({ method: _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestMethod"].Post, headers: header });
        return new Promise(function (resolve, reject) {
            _this.htttp.post('https://fcm.googleapis.com/fcm/send', body, request)
                .subscribe(function (res) {
                resolve(res);
                _this.addShopUpdateNotification(options.body, options.shopID);
            }, function (err) {
                reject(err);
            });
        });
    };
    Notificationservices.prototype.addShopUpdateNotification = function (body, shopID) {
