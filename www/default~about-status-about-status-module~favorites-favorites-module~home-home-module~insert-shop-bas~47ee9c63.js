(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~about-status-about-status-module~favorites-favorites-module~home-home-module~insert-shop-bas~47ee9c63"],{
...
var Commonservices = /** @class */ (function () {
    function Commonservices(http, toastCtrl, loadingCtrl, router) {
        this.http = http;
        this.toastCtrl = toastCtrl;
        this.loadingCtrl = loadingCtrl;
        this.router = router;
        this.isLoadShowHide = false;
        this.isLoadCloseHide = false;
        this.httpPost = function (options) {
            ...
            var isJson = (contentType && contentType.indexOf('json') !== -1) ? true : false;
            var params = options.paramData; //isJson ? options.paramData : $httpParamSerializer(options.paramData);
            var title = options.title;
            var spinner = Ladda && Ladda.create(options.laddaTarget);
            var httpCall;
            ...
            httpCall.subscribe(function (response) {
                if (isLoader) {
                    control.closeLoader();
                ...
                if (data.Code == _this.env.codeKeyPair.tokenExpired) {
                ...
                if (errorCode == _this.env.resultTable.success) {
        ...
        this.httpCommonMethod = function (options) {
            var _this = this;
            var params = options.paramData;
            var title = options.title;
            var httpCall;
    ...
    Commonservices.prototype.showAlert = function (resOptions) {
    ...
    Commonservices.prototype.msgToast = function (options) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    Commonservices.prototype.showLoader = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.isLoadShowHide == false)) return [3 /*break*/, 2];
                        _a = this;
    ...
    Commonservices.prototype.closeLoader = function () {
        var _this = this;
    ...
    Commonservices.prototype.infiniteScrollAndRefersh = function (infiniteScroll, refresher, data, listBinding) {
        var dataList = [];
        if (infiniteScroll) {
    ...
    Commonservices.prototype.commonValidation = function (event, length) {
    ...
    Commonservices.prototype.getTextBoxLength = function (value, textboxlength) {
        var Enterlength = value.length;
        var maxlength = textboxlength - Enterlength;
        return maxlength;
    };
    ;
    Commonservices.prototype.convertDateString = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_5__(date).format("ddd, Do MMM YYYY");
    };
    Commonservices.prototype.convertDateTimeString = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_5__(date).format("ddd, Do MMM YYYY hh:mm A");
    };
    Commonservices.prototype.removeShopStorage = function () {
    ...
    Commonservices.prototype.applyHaversine = function (locations) {
        var _this = this;
        var usersLocation = {
        ...
        locations.map(function (location) {
            ...
            location.distance = _this.getDistanceBetweenPoints(usersLocation, placeLocation, 'km').toFixed(1);
        });
        return locations;
    };
    Commonservices.prototype.getDistanceBetweenPoints = function (start, end, units) {
        if (end.lat == null) {
            var rt = 0.0;
            return rt;
        }
    ...
    Commonservices.prototype.toRad = function (x) {
        return x * Math.PI / 180;
    };
    Commonservices.prototype.getMinDate = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_5__(date).format('YYYY-MM-DD');
    };
    Commonservices.prototype.ConvertUTCToLocalDateTime = function (datetime) {
        var input = datetime;
        var fmt = 'YYYY-MM-DD, HH:mm:ss';
        var m = moment__WEBPACK_IMPORTED_MODULE_5__["utc"](input, fmt);
        return m.local().format(fmt);
    };
    Commonservices.prototype.ConvertLocalToUTCDateTime = function (datetime) {
        var input = datetime;
        var fmt = 'YYYY-MM-DD, HH:mm:ss';
        var m = moment__WEBPACK_IMPORTED_MODULE_5__["utc"](input, fmt);
        return m.utc().format(fmt);
    };
    Commonservices.prototype.getDateDayAndHour = function (date) {
        ...
        var minutes = Math.ceil((diff % (1000 * 60 * 60)) / (1000 * 60));
    ...
    Commonservices.prototype.profileText = function () {
        var namesFirstLetters = localStorage.getItem('FirstName').slice(0, 1) + localStorage.getItem('LastName').slice(0, 1);
        localStorage.setItem('TextForImage', namesFirstLetters);
        return console.log(namesFirstLetters);
    };
    Commonservices.prototype.profileTextLetter = function (firstName, lastName) {
        var namesFirstLetters = firstName.slice(0, 1) + lastName.slice(0, 1);
        return namesFirstLetters;
    };
    Commonservices.prototype.getFirstCapitalLetter = function (text) {
        text = text.charAt(0).toUpperCase() + text.substr(1).toLowerCase();
        return text;
    };
    Commonservices.prototype.getExtraTextHide = function (text, maxLength) {
    ...
    Commonservices.prototype.getExtraAddressHide = function (address, city, state, maxLength) {
        var fullAddress = address + ", " + city + ", " + state + ".";
        var textLength = fullAddress.length;
        if (maxLength <= textLength) {
...
var Env = /** @class */ (function () {
    function Env() {
        ...
        this.apiUrl = 'http://vmi105759.contabo.host/DiscountAppServer/api/';
        // Account Methods url
        this.accountApi = {
        ...
        // Common Methods url
        this.commonApi = {
            getAllCountriesURL: this.apiUrl + 'common/getAllCountries',
        ...
        this.ShopAdminStatus = {
            Reject: 1,
            Pending: 2,
            Approved: 3,
            Blocked: 4
        };
        this.imgServerFolder = {
            UserImage: 'Users',
            ShopImage: 'Shops'
        };
        this.codeKeyPair = {
        ...
        this.imageURL = 'http://vmi105759.contabo.host/DiscountAppServer/Images/';
    }
...
//# sourceMappingURL=default~about-status-about-status-module~favorites-favorites-module~home-home-module~insert-shop-bas~47ee9c63.js.map